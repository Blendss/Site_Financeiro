...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 13-Nov-2023 às 21:13
...
(66, '066 - BANCO MORGAN STANLEY S.A'),
(70, '070 - BANCO DE BRASILIA S.A'),
(77, '077 - BANCO DE INTER S.A'),
...
(129, '129 - UBS BRASIL BANCO DE INVESTIMENTO S.A.'),
...
CREATE TABLE IF NOT EXISTS `extrato` (
  `registro` bigint(120) NOT NULL AUTO_INCREMENT,
  `id` bigint(120) NOT NULL,
  `data` date DEFAULT NULL,
  `valor` decimal(65,2) NOT NULL,
  `debitocredito` char(7) NOT NULL,
  `id_transacao` int(3) NOT NULL,
  `descricao` varchar(150) NOT NULL,
  `nome` varchar(120) NOT NULL,
  `cod_banco` int(3) DEFAULT NULL,
...
INSERT INTO `tipogastos` (`cod_gasto`, `tipo`) VALUES
(1, 'Educação'),
(2, 'Saúde'),
(3, 'Lazer'),
(4, 'Transporte'),
...
CREATE TABLE IF NOT EXISTS `transacoes` (
  `cod_transacao` int(3) NOT NULL AUTO_INCREMENT,
  `id_transacao` int(3) NOT NULL,
...
INSERT INTO `transacoes` (`cod_transacao`, `id_transacao`, `transacao`) VALUES
(1, 1, 'Boleto'),
(2, 2, 'Deposito'),
(3, 3, 'Pix'),
(4, 4, 'Saque'),
...
--
-- Estrutura da tabela `usuariobancos`
--

DROP TABLE IF EXISTS `usuariobancos`;
CREATE TABLE IF NOT EXISTS `usuariobancos` (
  `registro` bigint(120) NOT NULL AUTO_INCREMENT,
  `id` bigint(120) NOT NULL,
  `cod` int(3) NOT NULL,
  PRIMARY KEY (`registro`)
